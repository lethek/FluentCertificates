...
/// <summary>
/// A <see cref="CertificateExporter"/> for a format written as PEM text.
/// Obtained by calling <see cref="CertificateExportBuilder.AsPem"/> or
/// <see cref="CertificateExportBuilder.AsPkcs7Pem"/>.
...
public sealed class PemCertificateExporter : CertificateExporter
{
    ...
    /// <see cref="CertificateExportBuilder.AsPkcs7Pem"/> it is the one <c>PKCS7</c> block.
    /// </summary>
    public string ToPemString()
        => Format == ExportFormat.Pkcs7Pem ? ExportPkcs7Pem() : ExportPem();
}
