...
/// <summary>An immutable set of predicates a <see cref="CertificateFinder"/> passes to its sources. A
/// result must satisfy every one of them.</summary>
public sealed class CertificateFilter
{
    ...
    /// <summary>The predicates, in the order they were added.</summary>
    ...
    /// <summary>Returns a new filter with <paramref name="predicate"/> added, compiling it once.</summary>
    ...
    /// <summary>Returns a new filter with <paramref name="predicate"/> added.</summary>
    /// <param name="predicate">The predicate to add.</param>
    /// <returns>A new filter.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="predicate"/> is null.</exception>
    ...
    /// <summary>Whether <paramref name="result"/> satisfies every predicate.</summary>
