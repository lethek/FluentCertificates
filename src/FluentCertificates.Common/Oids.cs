...
/// <summary>Object Identifier (OID) values used in X.509 certificates and related protocols.</summary>
public static class Oids
{
    ...
    // .NET 10 has no API for these prehash variants: they exist for reading certificates only, and
    // are deliberately absent from KeyAlgorithm.PostQuantumAlgorithms.
    ...
    // Checked against draft-ietf-lamps-pq-composite-sigs-19 s7 and, where .NET implements the set,
    // read back off a generated key; the five marked below are draft-only.
    ...
    /// <summary>MLDSA44-Ed25519-SHA512 public key and signature algorithm OID <c>1.3.6.1.5.5.7.6.39</c>. Draft-only.</summary>
    ...
    /// <summary>MLDSA65-ECDSA-brainpoolP256r1-SHA512 public key and signature algorithm OID <c>1.3.6.1.5.5.7.6.47</c>. Draft-only.</summary>
    public const string MLDsa65WithECDsaBrainpoolP256r1 = "1.3.6.1.5.5.7.6.47";
    /// <summary>MLDSA65-Ed25519-SHA512 public key and signature algorithm OID <c>1.3.6.1.5.5.7.6.48</c>. Draft-only.</summary>
    ...
    /// <summary>MLDSA87-ECDSA-brainpoolP384r1-SHA512 public key and signature algorithm OID <c>1.3.6.1.5.5.7.6.50</c>. Draft-only.</summary>
    public const string MLDsa87WithECDsaBrainpoolP384r1 = "1.3.6.1.5.5.7.6.50";
    /// <summary>MLDSA87-Ed448-SHAKE256 public key and signature algorithm OID <c>1.3.6.1.5.5.7.6.51</c>. Draft-only.</summary>
    ...
    // .NET 10 has no API for composite ML-KEM: these exist for reading certificates only.
    ...
    // policyIdentifier values that go inside the CertPolicies extension, not that extension's own OID.
    ...
    /// <summary>LDAP attribute OID <c>1.3.6.1.1.1.1.22</c> (<c>macAddress</c>), from RFC 2307 s2.3.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha3_384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="RsaPkcs1Sha3_512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Esdh"/>.</summary>
    public static Oid EsdhOid => LazyInitializer.EnsureInitialized(ref s_esdhOid, () => InitializeOid(Esdh));
    /// <summary>Cached <see cref="Oid"/> for <see cref="EcDiffieHellman"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="DiffieHellman"/>.</summary>
    public static Oid DiffieHellmanOid => LazyInitializer.EnsureInitialized(ref s_diffieHellmanOid, () => InitializeOid(DiffieHellman));
    /// <summary>Cached <see cref="Oid"/> for <see cref="DiffieHellmanPkcs3"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_128f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_192s"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_192f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_256s"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_256f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake128s"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake128f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake192s"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake192f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake256s"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake256f"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa44PreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65PreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87PreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_128sPreHashSha256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_128fPreHashSha256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_192sPreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_192fPreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_256sPreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaSha2_256fPreHashSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake128sPreHashShake128"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake128fPreHashShake128"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake192sPreHashShake256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake192fPreHashShake256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake256sPreHashShake256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SlhDsaShake256fPreHashShake256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa44WithRSA2048Pss"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa44WithRSA2048Pkcs15"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa44WithEd25519"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa44WithECDsaP256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithRSA3072Pss"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithRSA3072Pkcs15"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithRSA4096Pss"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithRSA4096Pkcs15"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithECDsaP256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithECDsaP384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithECDsaBrainpoolP256r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa65WithEd25519"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithECDsaP384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithECDsaBrainpoolP384r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithEd448"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithRSA3072Pss"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithRSA4096Pss"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLDsa87WithECDsaP521"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithRsaOaep3072Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithRsaOaep4096Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithX25519Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithECDiffieHellmanP256Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithECDiffieHellmanP384Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem768WithECDiffieHellmanBrainpoolP256r1Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem1024WithRsaOaep3072Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem1024WithECDiffieHellmanP384Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem1024WithECDiffieHellmanBrainpoolP384r1Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem1024WithX448Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MLKem1024WithECDiffieHellmanP521Sha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SigningCertificateV2"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="UserPrincipalName"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CertificateTemplate"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ApplicationCertPolicies"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="AuthorityInformationAccess"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SubjectInformationAccess"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="OcspEndpoint"/>.</summary>
    public static Oid OcspEndpointOid => LazyInitializer.EnsureInitialized(ref s_ocspEndpointOid, () => InitializeOid(OcspEndpoint));
    /// <summary>Cached <see cref="Oid"/> for <see cref="CertificateAuthorityIssuers"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs9ExtensionRequest"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs7SignedEnveloped"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs7Hashed"/>.</summary>
    public static Oid Pkcs7HashedOid => LazyInitializer.EnsureInitialized(ref s_pkcs7HashedOid, () => InitializeOid(Pkcs7Hashed));
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs7Encrypted"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EcChar2PentanomialBasis"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha3_256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha3_384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ECDsaWithSha3_512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="LocalityName"/>.</summary>
    public static Oid LocalityNameOid => LazyInitializer.EnsureInitialized(ref s_localityNameOid, () => InitializeOid(LocalityName));
    /// <summary>Cached <see cref="Oid"/> for <see cref="StateOrProvinceName"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Organization"/>.</summary>
    public static Oid OrganizationOid => LazyInitializer.EnsureInitialized(ref s_organizationOid, () => InitializeOid(Organization));
    /// <summary>Cached <see cref="Oid"/> for <see cref="OrganizationalUnit"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EmailAddress"/>.</summary>
    public static Oid EmailAddressOid => LazyInitializer.EnsureInitialized(ref s_emailAddressOid, () => InitializeOid(EmailAddress));
    /// <summary>Cached <see cref="Oid"/> for <see cref="TelephoneNumber"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Description"/>.</summary>
    public static Oid DescriptionOid => LazyInitializer.EnsureInitialized(ref s_descriptionOid, () => InitializeOid(Description));
    /// <summary>Cached <see cref="Oid"/> for <see cref="BusinessCategory"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="PostOfficeBox"/>.</summary>
    public static Oid PostOfficeBoxOid => LazyInitializer.EnsureInitialized(ref s_postOfficeBoxOid, () => InitializeOid(PostOfficeBox));
    /// <summary>Cached <see cref="Oid"/> for <see cref="PhysicalDeliveryOfficeName"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="X121Address"/>.</summary>
    public static Oid X121AddressOid => LazyInitializer.EnsureInitialized(ref s_x121AddressOid, () => InitializeOid(X121Address));
    /// <summary>Cached <see cref="Oid"/> for <see cref="InternationalISDNNumber"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="DestinationIndicator"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="HouseIdentifier"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CountryOrRegionName3C"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CountryOrRegionName3N"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="BasicConstraints"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SubjectKeyIdentifier"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="KeyUsage"/>.</summary>
    public static Oid KeyUsageOid => LazyInitializer.EnsureInitialized(ref s_keyUsageOid, () => InitializeOid(KeyUsage));
    /// <summary>Cached <see cref="Oid"/> for <see cref="SubjectAltName"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IssuerAltName"/>.</summary>
    public static Oid IssuerAltNameOid => LazyInitializer.EnsureInitialized(ref s_issuerAltNameOid, () => InitializeOid(IssuerAltName));
    /// <summary>Cached <see cref="Oid"/> for <see cref="BasicConstraints2"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CrlDistributionPoints"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="AuthorityKeyIdentifier"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CertPolicyConstraints"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EnhancedKeyUsage"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="FreshestCrl"/>.</summary>
    public static Oid FreshestCrlOid => LazyInitializer.EnsureInitialized(ref s_freshestCrlOid, () => InitializeOid(FreshestCrl));
    /// <summary>Cached <see cref="Oid"/> for <see cref="InhibitAnyPolicyExtension"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="TstInfo"/>.</summary>
    public static Oid TstInfoOid => LazyInitializer.EnsureInitialized(ref s_tstInfoOid, () => InitializeOid(TstInfo));

    /// <summary>Cached <see cref="Oid"/> for <see cref="ExtendedValidationCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="DomainValidatedCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="OrganizationValidatedCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IndividualValidatedCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ExtendedValidationCodeSigningCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CodeSigningRequirementsCertPolicy"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="AnyExtendedKeyUsage"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ServerAuthPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ClientAuthPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CodeSigningPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EmailProtectionPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IpsecEndSystemPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IpsecTunnelPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IpsecUserPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="TimeStampingPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="OcspSigningPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="DvcsPurpose"/>.</summary>
    public static Oid DvcsPurposeOid => LazyInitializer.EnsureInitialized(ref s_dvcsPurposeOid, () => InitializeOid(DvcsPurpose));
    /// <summary>Cached <see cref="Oid"/> for <see cref="SbgpCertAaServerAuthPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ScvpResponderPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EapOverPppPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="EapOverLanPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ScvpServerPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="ScvpClientPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="IpsecIkePurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CapwapAcPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="CapwapWtpPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SipDomainPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SecureShellClientPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SecureShellServerPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SendRouterPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SendProxiedRouterPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SendOwnerPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SendProxiedOwnerPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="BgpSecRouterPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="SmartCardLogonPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="LifetimeSigningPurpose"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12PbeWithShaAnd3Key3Des"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12PbeWithShaAnd2Key3Des"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12PbeWithShaAnd128BitRC2"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12PbeWithShaAnd40BitRC2"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12KeyBag"/>.</summary>
    public static Oid Pkcs12KeyBagOid => LazyInitializer.EnsureInitialized(ref s_pkcs12KeyBagOid, () => InitializeOid(Pkcs12KeyBag));
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12ShroudedKeyBag"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12SafeContentsBag"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12X509CertBagType"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MsPkcs12KeyProviderName"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="MsPkcs12MachineKeySet"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pkcs12SdsiCertBagType"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="PbeWithMD5AndDESCBC"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="PbeWithMD5AndRC2CBC"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="PbeWithSha1AndDESCBC"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="PbeWithSha1AndRC2CBC"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="Pbkdf2"/>.</summary>
    public static Oid Pbkdf2Oid => LazyInitializer.EnsureInitialized(ref s_pbkdf2Oid, () => InitializeOid(Pbkdf2));
    /// <summary>Cached <see cref="Oid"/> for <see cref="PasswordBasedEncryptionScheme2"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="HmacWithSha1"/>.</summary>
    public static Oid HmacWithSha1Oid => LazyInitializer.EnsureInitialized(ref s_hmacWithSha1Oid, () => InitializeOid(HmacWithSha1));
    /// <summary>Cached <see cref="Oid"/> for <see cref="HmacWithSha256"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="HmacWithSha384"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="HmacWithSha512"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="secp256r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="secp384r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="secp521r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="brainpoolP256r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="brainpoolP384r1"/>.</summary>
    ...
    /// <summary>Cached <see cref="Oid"/> for <see cref="UserId"/>.</summary>
    public static Oid UserIdOid => LazyInitializer.EnsureInitialized(ref s_userIdOid, () => InitializeOid(UserId));
    /// <summary>Cached <see cref="Oid"/> for <see cref="MacAddress"/>.</summary>
    ...
    private static Oid InitializeOid(string oidValue)
    {
        ...
        // Do not remove - reading FriendlyName initializes it from the value and locks it.
        _ = oid.FriendlyName;
    ...
    /// <summary>Compares two <see cref="Oid"/> instances by <see cref="Oid.Value"/>, ignoring the friendly name.</summary>
