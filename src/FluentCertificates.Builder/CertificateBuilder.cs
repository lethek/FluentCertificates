...
public record CertificateBuilder
{
    ...
    /// </summary>
    /// <remarks>
    /// This only applies to keys generated by the builder itself, and only when <see cref="KeyAlgorithm"/>
    /// is <see cref="KeyAlgorithm.ECDsa"/>. A key supplied through <see cref="SetKeyPair"/> already carries
    /// its own curve and is unaffected.
    /// </remarks>
