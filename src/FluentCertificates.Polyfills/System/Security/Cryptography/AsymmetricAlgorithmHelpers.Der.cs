...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    /// <remarks>Original copy sourced under the MIT license from: https://github.com/dotnet/runtime/blob/425fedc0fb005af24765faa3ed423222a7dbd963/src/libraries/System.Security.Cryptography/src/System/Security/Cryptography/AsymmetricAlgorithmHelpers.Der.cs</remarks>
    internal static partial class AsymmetricAlgorithmHelpers
    {
        ...
        internal static byte[] ConvertFromIeeeP1363Signature(byte[] signature, DSASignatureFormat targetFormat)
        {
            switch (targetFormat) {
                ...
                default:
                    throw new CryptographicException("The signature format '{0}' is unknown.", targetFormat.ToString());
            }
        }
            ...
            int fieldSizeBits)
        {
            switch (currentFormat) {
                ...
                default:
                    throw new CryptographicException("The signature format '{0}' is unknown.", currentFormat.ToString());
            }
        }
