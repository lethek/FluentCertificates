...
namespace System.Security.Cryptography
{
    ...
    /// </summary>
    /// <remarks>Original copy sourced under the MIT license from: https://github.com/dotnet/runtime/blob/425fedc0fb005af24765faa3ed423222a7dbd963/src/libraries/System.Security.Cryptography/src/System/Security/Cryptography/DSASignatureFormat.cs</remarks>
    ...
    internal static class DSASignatureFormatHelpers
    {
        ...
        internal static Exception CreateUnknownValueException(DSASignatureFormat signatureFormat) =>
            new ArgumentOutOfRangeException(nameof(signatureFormat), $"The signature format '{signatureFormat}' is unknown.");
    }
}
