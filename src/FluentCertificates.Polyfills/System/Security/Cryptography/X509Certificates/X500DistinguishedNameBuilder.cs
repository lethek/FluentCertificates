...
public sealed class X500DistinguishedNameBuilder
{
    ...
    public void Add(string oidValue, string value, UniversalTagNumber? stringEncodingType = null)
    {
        ...
        if (String.IsNullOrEmpty(oidValue)) throw new ArgumentException("The value cannot be an empty string.", nameof(oidValue));
    ...
    public void Add(Oid oid, string value, UniversalTagNumber? stringEncodingType = null)
    {
        ...
        if (string.IsNullOrEmpty(oid.Value))
            throw new ArgumentException("The 'oid.Value' string cannot be empty or null.", nameof(oid));
    ...
    public void AddEmailAddress(string emailAddress)
    {
        ...
        if (String.IsNullOrEmpty(emailAddress)) throw new ArgumentException("The value cannot be an empty string.", nameof(emailAddress));

        if (emailAddress.Length > 255) {
            throw new ArgumentException("The email address cannot exceed 255 characters.", nameof(emailAddress));
        }
    ...
    public void AddCommonName(string commonName)
    {
        ...
        if (String.IsNullOrEmpty(commonName)) throw new ArgumentException("The value cannot be an empty string.", nameof(commonName));
    ...
    public void AddLocalityName(string localityName)
    {
        ...
        if (String.IsNullOrEmpty(localityName)) throw new ArgumentException("The value cannot be an empty string.", nameof(localityName));
    ...
    public void AddCountryOrRegion(string twoLetterCode)
    {
        ...
        if (String.IsNullOrEmpty(twoLetterCode)) throw new ArgumentException("The value cannot be an empty string.", nameof(twoLetterCode));
        ...
        if (twoLetterCode.Length != 2 || !Tools.IsAsciiLetter(twoLetterCode[0]) || !Tools.IsAsciiLetter(twoLetterCode[1])) {
            throw new ArgumentException("The country or region code must be exactly two characters and contain characters between A through Z, inclusive.", nameof(twoLetterCode));
        }
    ...
    public void AddOrganizationName(string organizationName)
    {
        ...
        if (String.IsNullOrEmpty(organizationName)) throw new ArgumentException("The value cannot be an empty string.", nameof(organizationName));
    ...
    public void AddOrganizationalUnitName(string organizationalUnitName)
    {
        ...
        if (String.IsNullOrEmpty(organizationalUnitName)) throw new ArgumentException("The value cannot be an empty string.", nameof(organizationalUnitName));
    ...
    public void AddStateOrProvinceName(string stateOrProvinceName)
    {
        ...
        if (String.IsNullOrEmpty(stateOrProvinceName)) throw new ArgumentException("The value cannot be an empty string.", nameof(stateOrProvinceName));
    ...
    public void AddDomainComponent(string domainComponent)
    {
        ...
        if (String.IsNullOrEmpty(domainComponent)) throw new ArgumentException("The value cannot be an empty string.", nameof(domainComponent));
...
#else
        X500DistinguishedName name = new X500DistinguishedName(rented.AsSpan(0, encoded).ToArray());
#endif
    ...
    )
    {
        ...
        using (_writer.PushSequence()) {
            ...
            try {
                ...
                throw new ArgumentException($"The contents of the string are not valid for the '{stringEncodingType}' ASN.1 encoding.", paramName ?? nameof(value));
            }
        }
    ...
    private static UniversalTagNumber GetAndValidateTagNumber(UniversalTagNumber? stringEncodingType)
    {
        switch (stringEncodingType) {
            ...
            default:
                throw new ArgumentException("The specified UniversalTagNumber must be a string type.", nameof(stringEncodingType));
        }
    }
}
